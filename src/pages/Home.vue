...
<template>
  <div class="flex justify-between items-center">
    ...
    <div class="flex gap-4 items-center">
      <select @change="onChangeSelect" class="py-2 px-3 border rounded-md outline-none text-sm w-40">
      ...
      <div class="relative">
        <img class="absolute left-4 top-3 w-4" src="/search.svg" />
        <input
          @input="onChangeSearchInput"
          class="border rounded-md py-2 pl-10 pr-4 outline-none focus:border-gray-400 text-sm w-40"
          type="text"
          placeholder="Поиск..."
        />
      </div>
